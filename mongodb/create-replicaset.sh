...
function init_mongo_primary {
  ...
  # @params server container volume
  createMongoDBNode primary mongo_p /storage/mongo/
  # @params container
...
function init_mongo_secondaries {
  # @Params server container volume
  createMongoDBNode secondary1 mongo_s1 mongo_storage
  createMongoDBNode secondary2 mongo_arb mongo_storage
}
